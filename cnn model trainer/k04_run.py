...
###########     Load the model/Optimize function
if (gpun<2):
    parallel_model = keras.models.load_model('cnn_1800epochs.batchsize16384.h5')
else:
    parallel_model = multi_gpu_model(keras.models.load_model('cnn_48epochs.batchsize4096.h5'),gpus=gpun)
